...
source("Functions/estimate.ED.R") # contains funcion estimate.ED()
```  
...
This suggests that submicron particles are not relevant to organic matter supply and can thus be excluded from our analysis. Small particles are also not likely to be very important in most samples, but because they are more abundant and strongly implicated in previous works we will retain them.
...
Given the small amount of trophic discrimination we expect to see in Lys this data makes sense, with the majority of zooplankton falling within the particle phenylalanine $\dN$ domain.

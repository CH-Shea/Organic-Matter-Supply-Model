...
Next we will mean normalize the data for a subset of tracers, based on the information given above. This is particularly useful if essential amino acid $\dC$ values are to be included in the model. Note that the mean value of mean normalized tracers can be added as an additional tracer if that argument is made "TRUE" below.
...
save(posts.global, posts.global.long, 
     ...
     file = "Data/OSPsim_OMSM1_posteriors.RData")
```

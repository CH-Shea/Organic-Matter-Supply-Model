...
```{r export_filename}
export.file.name <- "ALOHAsim_OMSM_posteriors.RData"
```
...
# Model Assessment
Now let's gather up posteriors from the OMSM and plot those relative to the true values we used to simulate the data to get an idea for how the model is performing.

---
title: "Determination of D15N values in wild zooplaknton by regression analysis"
author: "Connor Shea"
...
The following notebook describes linear regression analysis of wild zooplankton AA-CSIA data with the goal of estimating amino acid TDFs. The regressions are constructed as follows:
  ...
  3. Trophic positions are calculated by assuming TDFs and beta values for Phe, Glx, and Phe.
  4. Phe-normalized $\dNAA$ values are regressed against TP-1.
  5. The slope of the regression yields the TDF. The slope + TDF(Phe) yields the $\dN$ value.
...
data.romero <- as.data.frame(read_excel("~/University_of_Hawaii/SIA_work/EXPORTS/Data/Literature/Romero-Romero2020.xlsx"))
```

...
for (iz in 1:zoops.n) { # zooplankton d15N loop
  ...
  mn[c(Tracers$constTDF,"d15NPhe")] <- base.sim[iz,c(Tracers$constTDF,"d15NPhe")] + 
    TDF_m[c(Tracers$constTDF,"d15NPhe")]*FWL
  ...
  var[c(Tracers$constTDF,"d15NPhe")] <- 
    sqrt(
      sum(zoops.f[iz,]^2*sd.anl^2)^2 +
        FWL^2*TDF_m.sd[c(SDTracers$constTDF,"SDd15NPhe")]^2 +

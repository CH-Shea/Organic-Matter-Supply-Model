...
```{r f-vs-TP, fig.width=6, fig.asp=0.8, dpi=300}
## MTS ##
ggplot() +
...
ggplot() +
  ...
  #            shape=1, alpha=0.5, size=0.2)+
  geom_smooth(aes(x = posts.zoops$f$mode$Surface, y = troph.disc$FWL),
              method = "lm",
              color = "royalblue4", fill = "skyblue1")+
  geom_point(aes(x = posts.zoops$f$mode$Surface, y = troph.disc$FWL),
